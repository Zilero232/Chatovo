...
import { micStateHandler, presenceHandler, tokenHandler, webhookHandler } from './handlers';
import { micStateRoute, tokenRoute } from './routes';
import type { Env } from '../shared/types';

export const livekitRouter = new OpenAPIHono<Env>()
  .openapi(tokenRoute, tokenHandler)
  .openapi(micStateRoute, micStateHandler)
