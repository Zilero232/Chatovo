...
let broadcastServerMessage = (_serverId: string, _message: RealtimeServerMessage): void => {};
...
export const emitServerEvent = (serverId: string, message: RealtimeServerMessage): void => {
  broadcastServerMessage(serverId, message);
};
