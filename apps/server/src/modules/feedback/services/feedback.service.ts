...
import type { ReportProblemInput } from './feedback.service.types';
...
export class FeedbackService {
  ...
  async reportProblem({ input, userId }: ReportProblemInput): Promise<void> {
    const { description, appVersion, userAgent, platform, screenshot } = input;
