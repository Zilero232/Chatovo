...
import type { HomeHeroVisualProps } from './HomeHeroVisual.types';

import { HOME_HERO_SPEAKERS, HOME_WAVE_BARS } from '../../../config';
import {
  HERO_SPEAKER_PULSE,
...
} from './HomeHeroVisual.motion';

import s from '../../HomePage.module.scss';

export const HomeHeroVisual = ({ liveLabel }: HomeHeroVisualProps) => (
  <motion.div
    aria-hidden
  ...
  >
    <div className={s.heroSpeakers}>
      {HOME_HERO_SPEAKERS.map((speaker, index) => (
        <motion.span
          key={speaker.id}
