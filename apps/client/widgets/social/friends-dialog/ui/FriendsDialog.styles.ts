export const friendsDialogStyles = {
  ...
  badge:
    'ml-1.5 inline-flex min-w-5 items-center justify-center rounded-full bg-brand-cyan px-1.5 text-[10px] font-semibold text-black shadow-[0_0_10px_-3px_oklch(0.82_0.16_200/0.7)]',
} as const;
