export const chatPanelStyles = {
  root: 'glass-strong absolute inset-0 z-40 flex w-full flex-col rounded-none border-0 border-white/8 border-l shadow-none transition-transform duration-300 ease-out data-[open=false]:pointer-events-none data-[open=false]:translate-x-full data-[open=true]:translate-x-0 sm:left-auto sm:w-[clamp(28rem,40vw,46rem)]',
