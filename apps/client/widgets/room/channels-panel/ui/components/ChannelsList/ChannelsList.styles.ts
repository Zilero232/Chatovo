export const channelsListStyles = {
  ...
  skeletonList: 'flex flex-col gap-1.5 px-2 py-1',
  skeletonItem: 'h-9 rounded-lg',
  emptyState: 'min-h-32 py-6',
  sectionLabel:
  ...
  search: 'px-2 pt-2',
  searchField:
    'group flex h-9 w-full items-center gap-2 rounded-lg border border-white/10 bg-shell-surface-raised px-2.5 transition-all hover:border-white/16 focus-within:border-brand-cyan/60 focus-within:ring-2 focus-within:ring-brand-cyan/25',
  searchIcon:
