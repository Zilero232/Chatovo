...
| `.github/workflows/release-web.yml` | CI/CD: lint → сборка образов → деплой |
...
После push в `master` workflow `.github/workflows/release-web.yml`:
...
Push в `master` — либо вкладка **Actions → Release Web → Run workflow**.
